...
def QoS_to_QoE_mapping(qos_metric, qos):
    ...
    if qos_metric == 'Latency' or qos_metric == 'Idle jitter':
        a = 0.00025
    ...
    elif qos_metric == 'Packet Drops' or qos_metric == 'Errors':
        a = 0.025
    elif qos_metric == 'CPU':
        a = 0.01
    elif qos_metric == 'Uptime':
        a = 0.000001
    ...
    #E[f(qos)]
    print('Expected system QoE for ', qos_metric, f'= {mos_vals.mean():.2f}')
